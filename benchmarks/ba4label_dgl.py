    ...
    def process(self):
        ...
        for _ in range(self.graphs_num):
            ...
            if which_type == 0:
                ...
                G, role_id, plug_id = build_graph(self.nodes_num-10, self.basis_type, list_shapes, start = 0, m = self.m)
